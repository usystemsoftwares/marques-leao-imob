    ...
    <>
      ...
      >
        ...
        <div className="ml-3 sm:ml-10 lg:ml-[8%] mt-[15%] sm:mt-[20%] lg:mt-[12.5%] font-medium max-w-[32.5ch]">
          <p className="font-bold text-lg sm:text-3xl lg:text-4xl xl:text-5xl font-baskervville">Pablo Marques</p>
          <p className="mt-2 text-[.75rem] sm:text-base xl:text-lg !leading-[1.3]">Atuando a mais de 12 anos no mercado imobiliário, tive o privilégio de impactar dezenas de pessoas ao longo da minha trajetório, o que me trouxe expertise quando o assunto é imóveis e transformação de vidas. Com foco em imóveis de médio e alto padrão na região de Novo Hamburgo e Campo Bom, sou especialista em ativos imobiliários e estratégias de marketing imobiliário.</p>
        </div>
      </motion.div>
      <Image
      ...
      >
        ...
        <div className="text-end font-medium mt-[30%] sm:mt-[68%] lg:mt-[50%] xl:mt-[68%] translate-x-[-.5rem]">
          <p className="font-semibold text-lg sm:text-3xl lg:text-[2rem] xl:text-[2.75rem] font-baskervville">Gabriel Leão</p>
          <p className="mt-2 lg:mt-4 text-[.75rem] sm:text-base xl:text-lg !leading-[1.3]">Meu nome é Gabriel Leão, sou um dos fundadores da Marques & Leão, tenho 32 anos, morador de Novo Hamburgo, casado com a Nina, que é dona do meu coração e pai de pet do meu cachorrinho chamado Véio, atuo no mercado imobiliário há quase 11 anos, profissão onde me encontrei e sou apaixonado pelo que faço!</p>
        </div>
      </motion.div>
    </>
  )
