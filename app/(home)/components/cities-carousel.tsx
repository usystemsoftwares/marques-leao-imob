    ...
    <div className={`embla overflow-x-hidden font-baskervville mt-8`}>
      <div className="embla__viewport" ref={emblaRef}>
        <div className="embla__container *:w-[min(100%,16.875rem)] *:cursor-pointer *:h-[9.313rem] *:md:h-auto *:overflow-hidden *:rounded-[.625rem] md:*:rounded-lg *:relative *:flex-shrink-0 *:flex-grow-0 gap-6 md:gap-12">
          <Link
            href="/imoveis/estado-rio-grande-do-sul/cidade-novo-hamburgo"
            className="group"
          >
            <Image
              src={NovoHamburgo}
            ...
            />
            <p className="absolute b-0 text-center w-full py-2 bg-mainPurple bg-opacity-60 bottom-0 opacity-0 group-hover:opacity-100 transition-opacity">
              Conhecer imóveis
            </p>
            <p className="absolute bottom-0 text-center w-full py-2 bg-[#666666] bg-opacity-60 group-hover:opacity-0 transition-opacity">
              Novo Hamburgo
            </p>
          </Link>
          <Link
            href="/imoveis/estado-rio-grande-do-sul/cidade-campo-bom"
            className="group"
          >
            <Image
              src={CampoBom}
          ...
          <Link
            href="/imoveis/estado-rio-grande-do-sul/cidade-estancia-velha"
            className="group"
          >
            <Image
              src={EstanciaVelha}
          ...
          <Link href="/imoveis/estado-santa-catarina" className="group">
            <Image
              src={SantaCatarina}
